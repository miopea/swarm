...
def _serialize_drones(config: HiveConfig) -> dict[str, Any]:
    ...
    drones_dict: dict[str, Any] = {
        ...
        "nudge_idle_for_informational": d.nudge_idle_for_informational,
        "message_fanout_max_recipients": d.message_fanout_max_recipients,
        "message_fanout_window_seconds": d.message_fanout_window_seconds,
        "prompt_collision_window_seconds": d.prompt_collision_window_seconds,
        "suppress_duplicate_handoff": d.suppress_duplicate_handoff,
        "duplicate_title_similarity": d.duplicate_title_similarity,
